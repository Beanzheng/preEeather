	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			if(ServiceFactory.getUserServiceInstace().resigter(userName, password, sex)){
					printWriter.print("<a href='/preWeather/html/frontweb/web/login.html'>注册成功，点击登录</a>");
//					response.sendRedirect("/preWeather/html/login.html");
			}else {
					printWriter.print("<a href='/preWeather/html/register.html'>注册失败，点击重新注册</a>");
			}
		}catch(Exception e){
			printWriter.print("<a href='/preWeather/html/frontweb/web/register.html'>注册失败，点击重新注册</a>");
			e.printStackTrace();
		}			
