...
$(document).ready(function(){
	$(".mbtn1").click(function(){
		...
		$.ajax({
            ...
            url: '/preWeather/Weather_searche',
            type:"post",
            dataType: 'JSON',
			...
			<div class="w3layouts_main_grid_left">
				...
				<div class="w3l_search_bottom">
					<ul class="w3ls_weather">
						<li><i>7:00 AM</i><a href='../ReturnPictureUrl?cityName=American'><%=session.getAttribute("city") %></a><span><%=session.getAttribute("temp") %>°</span></li>
						<li><i>8:00 AM</i><a href='../ReturnPictureUrl?cityName=China'><%=session.getAttribute("city2") %></a><span><%=session.getAttribute("temp2") %>°</span></span></li>
						<li><i>9:00 PM</i><a href='../ReturnPictureUrl?cityName=Argentina'><%=session.getAttribute("city3") %></a><span><%=session.getAttribute("temp3") %>°</span></span></li>
						<li><i>10:00 AM</i><a href='../ReturnPictureUrl?cityName=Australia'><%=session.getAttribute("city4") %></a><span><%=session.getAttribute("temp4") %>°</span></span></li>
						<li><i>12:00 PM</i><a href='../ReturnPictureUrl?cityName=Belarus'><%=session.getAttribute("city5") %></a><span><%=session.getAttribute("temp5") %>°</span></span></li>
						<li><i>14:00 PM</i><a href='../ReturnPictureUrl?cityName=Chile'><%=session.getAttribute("city6") %></a><span><%=session.getAttribute("temp6") %>°</span></span></li>
					</ul>
			...
			<div class="w3layouts_main_grid_right">
				<div class="agileits_w3layouts_main_grid_right">
					<div class="w3_agile_main_grid_left">
						<h2><%=session.getAttribute("cityNameso") %></h2>
						<p><i class="fa fa-clock-o" aria-hidden="true"></i><%=session.getAttribute("cityTempso") %></p>
					</div>
					<div class="w3_agile_main_grid_right ">
					<img src="images/1.jpg" class="imgw3">
